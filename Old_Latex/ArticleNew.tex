...
as (\ref{MeanEnergy}), suggesting that the normalized dissipation
...
Using this observation we tested the shock model by plotting the normalized and
...
normalized density increment rather than a displacement increment. If shocks in
