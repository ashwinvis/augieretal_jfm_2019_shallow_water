...
\caption{Spatio-temporal spectra of KE  and APE for $c = 20$ and $n = 3840$ versus $\omega/\omega_l$, where
...
can be explained only by nonlinear effects.  The equipartition
