...
if __name__ == "__main__":
    ...
    sim0 = fls.load_state_phys_file(
        paths_sim[short_names[0]], merge_missing_params=True
    )
    sim1 = sim0
    sim1 = fls.load_state_phys_file(
        paths_sim[short_names[1]], merge_missing_params=True
    )
    keys = ["div", "uy", "div", "uy"]
